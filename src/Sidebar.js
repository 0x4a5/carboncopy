...
function Sidebar() {
  return (
    ...
    <Button className='side_compose' startIcon={<AddOutlinedIcon fontSize='medium'/>}>Compose</Button>
    <SidebarSelections Icon={InboxIcon} title='Inbox' number={18} selected={true}/>
    ...
    <SidebarSelections Icon={LabelImportantIcon} title='Important' number={18}/>
